...
```
The bar chart above helps us understand the distribution of fast food restaurants across the U.S. It displays the total number of restaurants according to the state.  
...
```
Above shows summarised information regarding [insert rest of description]

## Number of Fast Food Locations by State (Similar to other?)
```{r}

```
The [type of] chart above [insert description]
